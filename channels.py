...
channels = {
    ...
    "Fridge Watts": Channel("Fridge Watts", 0, 627.2, "Fridge.*Watts$", check_limits),
    "Ground Level Plugs Watts": Channel("Ground Level Plugs Watts", 0, 3000, "Ground.*Level.*Plugs?.*Watts$", check_limits),
    "HRV Watts": Channel("HRV Watts", 0, 400, "HRV.*Watts$", check_limits),
    ...
    "PV Generation 2 Watts": Channel("PV Generation 2 Watts", 0, 1000, "PV.*Generation.*2.*Watts$", check_limits),
