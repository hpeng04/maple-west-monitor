...
def download_all():
    ...
    #google_upload(locations[i][4], "/home/charlie/SCRIPTS/data/" + locations[i][1] + "_" + yesterday.strftime("%Y-%m-%d") + "_missing.csv", locations[i][1] + "_" + yesterday.strftime("%Y-%m-%d") + "_missing.csv")
